    ...
    <>
      ...
      <div className="relative pb-32 flex flex-col justify-between items-center">
        <div className="flex md:gap-16 gap-10">
          <a href="mailto:hideffrand@gmail.com" className="md:w-20 md:h-20 w-14 h-14 translate-y-12 hover:cursor-pointer">
            <Image className="w-full" src="/gmail.svg" height={800} width={800} alt="Gmail" priority />
          </a>
          <a href="https://www.linkedin.com/in/deffrand-farera/" className="md:w-20 md:h-20 w-14 h-14 hover:cursor-pointer">
            <Image className="w-full" src="/linkedin.svg" height={800} width={800} alt="LinkedIn" priority />
          </a>
          <a href="https://www.github.com/hideffrand" className="md:w-20 md:h-20 w-14 h-14 translate-y-12 hover:cursor-pointer">
            <Image className="w-full" src="/github.svg" height={800} width={800} alt="Github" priority />
          </a>
        </div>
        <Image className="absolute bottom-0" src="/beam.svg" width={800} height={800} alt="Beams" />
      </div>
    </>
  );
};
